...
function timeline() {
    platform.getAllSessions().then((data) => {
        getIndexSessionData(data).then((i) => {
            ...
            else if ((updatedDates.fullDate.getDate() == updatedDates.yesterdayPlusOne.getDate()) || (studySessionData.subId == "64a1176daa154e67c58b95e4")) { //|| yesterdayPlusOne.getDate() - fullDate.getDate() > 25 ) {)
